...
<div class="row">
    <div class="col-md-12">
        <div class="profile-container" style="background: url({{ asset('dashboard_assets') }}/assets/media/image/image1.jpg)">
            <div class="profile-bar">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <small class="opacity-7 text-capitalize">{{ auth()->user()->role }}</small>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-8">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex mb-3">
                                    <div class="d-flex">
                                        <figure class="avatar mr-3">
                                            <img src="{{ asset('dashboard_assets') }}/assets/media/image/user/man_avatar1.jpg"
                                ...
                                <a href="#">
                                    <div class="row no-gutters border border-radius-1">
                                        <div class="col-3">
                                            <img src="{{ asset('dashboard_assets') }}/assets/media/image/photo1.jpg"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex mb-3">
                                    <div class="d-flex">
                                        <figure class="avatar mr-3">
                                            <img src="{{ asset('dashboard_assets') }}/assets/media/image/user/man_avatar3.jpg"
                                                 class="rounded-circle" alt="...">
                                        </figure>
                                        <div class="d-inline-block">
                                            <div><strong>Martina Ash</strong> shared a link</div>
                                ...
                                <div class="mt-4">
                                        ...
                                        <div class="d-flex mb-3">
                                            <div class="d-flex align-items-center">
                                                <figure class="avatar avatar-sm mr-3">
                                                    <img
                                                        src="{{ asset('dashboard_assets') }}/assets/media/image/user/man_avatar4.jpg"
                                                        class="rounded-circle" alt="...">
                                                </figure>
                                                <div class="d-inline-block">
                                                    <div><strong>Martina Ash</strong> shared a link</div>
                                    ...
                                    <div class="card card-body border p-3">
                                        <div class="d-flex mb-3">
                                            <div class="d-flex align-items-center">
                                                <figure class="avatar avatar-sm mr-3">
                                                    <img
                                                        src="{{ asset('dashboard_assets') }}/assets/media/image/user/man_avatar1.jpg"
                                                        class="rounded-circle" alt="...">
                                                </figure>
                                                <div class="d-inline-block">
                                                    <div><strong>Martina Ash</strong> shared a link</div>
                                    ...
                                    <form class="d-flex">
                                        <div>
                                            <figure class="avatar mr-3">
                                                <img
                                                    src="{{ asset('dashboard_assets') }}/assets/media/image/user/women_avatar1.jpg"
                                                    class="rounded-circle" alt="...">
                                            </figure>
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex mb-3">
                                    <div class="d-flex">
                                        <figure class="avatar mr-3">
                                            <img src="{{ asset('dashboard_assets') }}/assets/media/image/user/women_avatar2.jpg"
                                                 class="rounded-circle" alt="...">
                                        </figure>
                                        <div class="d-inline-block">
                                            <div>Anna Mull</div>
                                ...
                                <div class="row row-xs">
                                    <div class="col-6">
                                        <img src="{{ asset('dashboard_assets') }}/assets/media/image/photo9.jpg"
                                             class="w-100 border-radius-1"
                                             alt="image/">
                                    </div>
                                    <div class="col-6">
                                        <img src="{{ asset('dashboard_assets') }}/assets/media/image/photo10.jpg"
                                             class="w-100 border-radius-1"
                                             alt="image/">
                                    </div>
                                </div>
                                        ...
                                        <div>
                                            <a href="#">
                                                <figure class="avatar avatar-sm mr-3 bring-forward">
                                                    <img
                                                        src="{{ asset('dashboard_assets') }}/assets/media/image/user/man_avatar2.jpg"
                                            ...
                                            <a href="#">
                                                <div class="mb-3 border border-radius-1">
                                                    <div class="row no-gutters">
                                                        <div class="col-2">
                                                            <img
                                                                src="{{ asset('dashboard_assets') }}/assets/media/image/photo1.jpg"
                                                                class="w-100"
                                                                alt="image/">
                                                        </div>
                                        ...
                                        <span>
                                            ...
                                            <div class="row row-xs">
                                                <div class="col-xl-3 col-lg-4 col-md-6">
                                                    <figure>
                                                        <img
                                                            src="{{ asset('dashboard_assets') }}/assets/media/image/portfolio-five.jpg"
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-md-6">
                                                    <figure>
                                                        <img
                                                            src="{{ asset('dashboard_assets') }}/assets/media/image/portfolio-one.jpg"
                                                            class="w-100 border-radius-1" alt="image/">
                                                    </figure>
                                                </div>
                                                <div class="col-xl-3 col-lg-4 col-md-6">
                                                    <figure>
                                                        <img
                                                            src="{{ asset('dashboard_assets') }}/assets/media/image/portfolio-three.jpg"
                                                            class="w-100 border-radius-1" alt="image/">
                                                    </figure>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body p-3">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <figure class="avatar mr-3">
                                                            <img
                                                                src="{{ asset('dashboard_assets') }}/assets/media/image/user/women_avatar2.jpg"
                                                                class="rounded-circle" alt="...">
                                                        </figure>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="card-body p-3">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <figure class="avatar mr-3">
                                                            <img
                                                                src="{{ asset('dashboard_assets') }}/assets/media/image/user/women_avatar3.jpg"
                                                                class="rounded-circle" alt="...">
                                                        </figure>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="card-body p-3">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <figure class="avatar mr-3">
                                                            <img
                                                                src="{{ asset('dashboard_assets') }}/assets/media/image/user/women_avatar4.jpg"
                                                                class="rounded-circle" alt="...">
                                                        </figure>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="card-body p-3">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <figure class="avatar mr-3">
                                                            <img
                                                                src="{{ asset('dashboard_assets') }}/assets/media/image/user/man_avatar5.jpg"
                                                                class="rounded-circle" alt="...">
                                                        </figure>
                                                    </div>
                                                    <div>
                ...
                {{-- <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">Update Passsword</h3>
                ...
                {{-- <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">Remove Your Account</h3>

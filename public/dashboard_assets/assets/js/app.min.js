...
/* ------------------------------------------------------------------
    ...
    Name:       Asimo - Responsive Admin Dashboard Template
    File name:  app.js
    Author:     laborasyon
...
(function ($) {
  ...
  if (!body_.hasClass('small-navigation') && !body_.hasClass('horizontal-navigation') && wind_.width() >= 992) {
    ...
    $(nice.rail[0]).addClass("navigation-nicescroll");
  } // Search Bar Open [data-action="search"]


  $(document).on('click', '[data-action="search-bar"]', function (e) {
    $('.header-search-bar').slideToggle(200);
    setTimeout(function () {
      $('.header-search-bar input[type="text"]').focus();
    }, 250);
    return false;
  }); // Search Bar Close [data-action="search"]

  $(document).on('click', '[data-action="search-bar-close"]', function (e) {
...
__webpack_require__(/*! C:\wamp64\www\themeforest\asimo\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\wamp64\www\themeforest\asimo\public\assets\sass\app.scss */"./public/assets/sass/app.scss");
